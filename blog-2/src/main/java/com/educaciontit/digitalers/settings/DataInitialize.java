...
public class DataInitialize implements CommandLineRunner {
	...
	private void users() {
		...
		userRepository.save(User.builder().email("user1@gmail.com")
				...
				.publications(Arrays.asList(Publication.builder().title("Publication 1").body(
						"Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...").user(User.builder().id(1L).build()).build()))
				.build());
